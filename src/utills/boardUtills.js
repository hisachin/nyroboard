...
export const createElement = (
  ...
  try {
    if (toolType == "line") {
      ...
      return { id, x1, y1, x2, y2, toolType, roughEle, width, strokeColor };
    } else if (toolType == "rectangle") {
      const roughEle = gen.rectangle(x1, y1, x2 - x1, y2 - y1, {
        stroke: strokeColor,
        strokeWidth: width,
      });
      return { id, x1, y1, x2, y2, toolType, roughEle, width, strokeColor };
    } else if (toolType == "circle") {
      const roughEle = gen.circle(x1, y1, 2 * (x2 - x1 + y2 - y1), {
        stroke: strokeColor,
        strokeWidth: width,
      });
      return { id, x1, y1, x2, y2, toolType, roughEle, width, strokeColor };
...
export const adjustElementCoordinates = (element) => {
  const { toolType, x1, y1, x2, y2 } = element;
